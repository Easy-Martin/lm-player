...
var Api=/*#__PURE__*/function(){function Api(video,playContainer,event,flv,hls){Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this,Api);this.player=video;this.playContainer=playContainer;this.flv=flv;this.hls=hls;this.event=event;this.scale=1;this.position=[0,0];}/**
   ...
   * 视频重载
   */},{key:"reload",value:function reload(){this.unload();this.load();this.play();this.event.emit(_event_eventName__WEBPACK_IMPORTED_MODULE_3__["default"].RELOAD);if(this.getCurrentTime!==0){this.seekTo(0);}}},{key:"unload",value:function unload(){this.flv&&this.flv.unload();this.hls&&this.hls.stopLoad();}},{key:"load",value:function load(){this.flv&&this.flv.load();if(this.hls){try{this.hls.swapAudioCodec();this.hls.recoverMediaError();}catch(e){}this.hls.startLoad();}}},{key:"setVolume",value:function setVolume(fraction){this.player.volume=fraction;}},{key:"mute",value:function mute(){this.player.muted=true;}},{key:"unmute",value:function unmute(){this.player.muted=false;}/**
   * 开启画中画功能
...
function Bar(_ref){var _ref$visibel=_ref.visibel,visibel=_ref$visibel===void 0?true:_ref$visibel,_ref$className=_ref.className,className=_ref$className===void 0?"":_ref$className,children=_ref.children,props=Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref,["visibel","className","children"]);if(visibel===false){return null;}return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span",Object.assign({className:"contraller-bar-item ".concat(className)},props),children);}
...
/* harmony import */ var _bar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./bar */ "./src/contraller_bar/bar.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../util */ "./src/util.js");
var _class,_temp;var RightBar=Object(_context__WEBPACK_IMPORTED_MODULE_6__["videoDec"])(_class=(_temp=/*#__PURE__*/function(_React$Component){Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(RightBar,_React$Component);function RightBar(){var _getPrototypeOf2;var _this;Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this,RightBar);for(var _len=arguments.length,_args=new Array(_len),_key=0;_key<_len;_key++){_args[_key]=arguments[_key];}_this=Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this,(_getPrototypeOf2=Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(RightBar)).call.apply(_getPrototypeOf2,[this].concat(_args)));_this.update=function(){_this.forceUpdate();};_this.fullscreen=function(){var _this$props=_this.props,api=_this$props.api,playContainer=_this$props.playContainer;if(!Object(_util__WEBPACK_IMPORTED_MODULE_9__["isFullscreen"])(playContainer)){api.requestFullScreen();}else{api.cancelFullScreen();}_this.forceUpdate();};_this.setScale=function(){var _this$props2=_this.props,api=_this$props2.api,playContainer=_this$props2.playContainer;var dragDom=playContainer.querySelector(".player-mask-layout");api.setScale.apply(api,arguments);var position=Object(_util__WEBPACK_IMPORTED_MODULE_9__["computedBound"])(dragDom,api.getPosition(),api.getScale());position&&api.setPosition(position,true);};_this.snapshot=function(){var _this$props3=_this.props,api=_this$props3.api,playerProps=_this$props3.playerProps;if(playerProps.snapshot){playerProps.snapshot(api.snapshot());}};return _this;}Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(RightBar,[{key:"componentDidMount",value:function componentDidMount(){Object(_util__WEBPACK_IMPORTED_MODULE_9__["fullScreenListener"])(true,this.update);}},{key:"componentWillUnmount",value:function componentWillUnmount(){Object(_util__WEBPACK_IMPORTED_MODULE_9__["fullScreenListener"])(false,this.update);}},{key:"render",value:function render(){var _this2=this;var _this$props4=this.props,playContainer=_this$props4.playContainer,playerProps=_this$props4.playerProps;var isScale=playerProps.isScale,snapshot=playerProps.snapshot,_playerProps$rightExt=playerProps.rightExtContents,rightExtContents=_playerProps$rightExt===void 0?null:_playerProps$rightExt,_playerProps$rightMid=playerProps.rightMidExtContents,rightMidExtContents=_playerProps$rightMid===void 0?null:_playerProps$rightMid;var isfull=Object(_util__WEBPACK_IMPORTED_MODULE_9__["isFullscreen"])(playContainer);return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div",{className:"contraller-right-bar"},rightMidExtContents,isScale&&react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment,null,react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_bar__WEBPACK_IMPORTED_MODULE_8__["default"],null,react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_iconfont__WEBPACK_IMPORTED_MODULE_7__["default"],{title:"\u7F29\u5C0F",onClick:function onClick(){return _this2.setScale(-0.2);},type:"lm-player-ZoomOut_Main"})),react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_bar__WEBPACK_IMPORTED_MODULE_8__["default"],null,react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_iconfont__WEBPACK_IMPORTED_MODULE_7__["default"],{title:"\u590D\u4F4D",onClick:function onClick(){return _this2.setScale(1,true);},type:"lm-player-ZoomDefault_Main"})),react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_bar__WEBPACK_IMPORTED_MODULE_8__["default"],null,react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_iconfont__WEBPACK_IMPORTED_MODULE_7__["default"],{title:"\u653E\u5927",onClick:function onClick(){return _this2.setScale(0.2);},type:"lm-player-ZoomIn_Main"}))),snapshot&&react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_bar__WEBPACK_IMPORTED_MODULE_8__["default"],null,react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_iconfont__WEBPACK_IMPORTED_MODULE_7__["default"],{title:"\u622A\u56FE",onClick:this.snapshot,type:"lm-player-SearchBox"})),react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_bar__WEBPACK_IMPORTED_MODULE_8__["default"],null,react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_iconfont__WEBPACK_IMPORTED_MODULE_7__["default"],{title:isfull?"窗口":"全屏",onClick:this.fullscreen,type:isfull?"lm-player-ExitFull_Main":"lm-player-Full_Main"})),rightExtContents);}}]);return RightBar;}(react__WEBPACK_IMPORTED_MODULE_5___default.a.Component),_temp))||_class;/* harmony default export */ __webpack_exports__["default"] = (RightBar);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function getHiddenProp(){var prefixes=["webkit","moz","ms","o"];// 如果hidden 属性是原生支持的，我们就直接返回
if("hidden"in document){return"hidden";}// 其他的情况就循环现有的浏览器前缀，拼接我们所需要的属性
for(var i=0;i<prefixes.length;i++){// 如果当前的拼接的前缀在 document对象中存在 返回即可
if(prefixes[i]+"Hidden"in document){return prefixes[i]+"Hidden";}}// 其他的情况 直接返回null
return null;}function getVisibilityState(){var prefixes=["webkit","moz","ms","o"];if("visibilityState"in document){return"visibilityState";}for(var i=0;i<prefixes.length;i++){if(prefixes[i]+"VisibilityState"in document){return prefixes[i]+"VisibilityState";}}// 找不到返回 null
return null;}function visibilityState(){return document[getVisibilityState()];}function addEventListener(listener){var visProp=getHiddenProp();var evtname=visProp.replace(/[H|h]idden/,"")+"visibilitychange";document.addEventListener(evtname,listener,false);}function removeEventListener(listener){var visProp=getHiddenProp();var evtname=visProp.replace(/[H|h]idden/,"")+"visibilitychange";document.removeEventListener(evtname,listener,false);}/* harmony default export */ __webpack_exports__["default"] = ({addEventListener:addEventListener,removeEventListener:removeEventListener,visibilityState:visibilityState});
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: default, Player, HistoryPlayer, createHistoryPlayer, createPlayer, Bar */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _contraller_bar_bar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./contraller_bar/bar */ "./src/contraller_bar/bar.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Bar", function() { return _contraller_bar_bar__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _createPlayer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createPlayer */ "./src/createPlayer.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createHistoryPlayer", function() { return _createPlayer__WEBPACK_IMPORTED_MODULE_3__["createHistoryPlayer"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createPlayer", function() { return _createPlayer__WEBPACK_IMPORTED_MODULE_3__["createPlayer"]; });
...
/* harmony import */ var _event_browserTabEvent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./event/browserTabEvent */ "./src/event/browserTabEvent.js");
var _class,_temp;var LiveHeart=Object(_context__WEBPACK_IMPORTED_MODULE_6__["videoDec"])(_class=(_temp=/*#__PURE__*/function(_React$Component){Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(LiveHeart,_React$Component);function LiveHeart(props){var _this;Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this,LiveHeart);_this=Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this,Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(LiveHeart).call(this,props));_this.browserTabChange=function(){if(_event_browserTabEvent__WEBPACK_IMPORTED_MODULE_8__["default"].visibilityState()==="visible"){_this.focusSeekAction();}};_this.canplay=function(){var api=_this.props.api;_this.isCanPlay=true;api.play();};_this.focusSeekAction=function(){var api=_this.props.api;var current=api.getCurrentTime();var buffered=api.getSecondsLoaded();if(buffered-current>5){console.warn("\u5F53\u524D\u5EF6\u65F6\u8FC7\u5927current->".concat(current," buffered->").concat(buffered,", \u57FA\u4E8E\u89C6\u9891\u5F53\u524D\u7F13\u5B58\u65F6\u95F4\u66F4\u65B0\u5F53\u524D\u64AD\u653E\u65F6\u95F4 updateTime -> ").concat(buffered-2));api.seekTo(buffered-2>0?buffered-2:0);}};_this.timer=null;_this.isCanPlay=false;return _this;}Object(D_Project_lm_player_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(LiveHeart,[{key:"componentDidMount",value:function componentDidMount(){var event=this.props.event;_event_browserTabEvent__WEBPACK_IMPORTED_MODULE_8__["default"].addEventListener(this.browserTabChange);event.addEventListener("canplay",this.canplay);}},{key:"componentWillUnmount",value:function componentWillUnmount(){var event=this.props.event;_event_browserTabEvent__WEBPACK_IMPORTED_MODULE_8__["default"].removeEventListener(this.browserTabChange);event.removeEventListener("canplay",this.canplay);}},{key:"render",value:function render(){return null;}}]);return LiveHeart;}(react__WEBPACK_IMPORTED_MODULE_5___default.a.Component),_temp))||_class;/* harmony default export */ __webpack_exports__["default"] = (LiveHeart);
